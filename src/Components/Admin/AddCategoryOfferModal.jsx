...
import { useAddCategoryOffersMutation } from "../../Store/Api/admin/offer";
import { useForm } from "react-hook-form";
import { yupResolver } from "@hookform/resolvers/yup";
import { offerSchema } from "../../Utils/YupSchemas";

const AddCategoryOfferModal = ({ open, handleClose, categoryId }) => {
  const [add, { isLoading }] = useAddCategoryOffersMutation();
  const {
    register,
    handleSubmit,
    formState: { errors },
...
export default AddCategoryOfferModal;
