...
import { useEditAddressMutation } from "../../Store/Api/user/address";
...
const EditAddressModal = ({ open, handleClose, address, update }) => {
  const [edit, { isLoading }] = useEditAddressMutation();
  ...
  const onSubmit = async (data) => {
    try {
      const res = await edit({ id: address._id, data }).unwrap();
      if (update) {
        update(res.address);
      }
