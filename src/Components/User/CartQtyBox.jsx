...
const CartQtyBox = () => {
  ...
  return (
    <div className="qtyBox w-full h-full flex items-center relative bg-[#f1f1f1]">
      <input
        ref={qtyRef}
        type="number"
        defaultValue={1}
        className="w-full h-full p-2 pl-3 text-[12px] focus:outline-none border-1 border-[rgba(0,0,0,0.2)] rounded-md"
      />
