...
import { clearUser, setUser, setUserLoading } from "./Store/StoreSlices/userAuthSlice";
import { Route, Routes } from "react-router-dom";
import { useAdminAuthMeQuery } from "./Store/Api/admin/auth";
import { clearAdmin, setAdmin, setAdminLoading } from "./Store/StoreSlices/adminAuthSlice";
...
function App() {
  ...
  const isLoading = userAuth.isLoading || adminAuth.isLoading;
