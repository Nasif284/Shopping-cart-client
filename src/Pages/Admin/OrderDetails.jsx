...
import { useApproveReturnMutation, useGetItemsByOrderIdQuery, useRejectReturnMutation } from "../../Store/Api/admin/orders";
...
const OrderDetails = () => {
  ...
  const [open, setOpen] = useState(false);
    ...
    const { data, isLoading } = useGetItemsByOrderIdQuery(id, {refetchOnMountOrArgChange: true});
